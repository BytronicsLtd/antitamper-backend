...
module.exports = ({ app }) => {
  ...
  app.patch('/api/v1/factories/:id', { preHandler: [authenticate,checkRole(['sys-admin'])] }, (req,res) => {
    factoriesController.updateFactory(req,res);
  });

  // Deactivate a factory (with role check)
  app.delete('/api/v1/factories/:id', { preHandler: [authenticate, checkRole(['sys-admin'])] }, (req,res) => {
